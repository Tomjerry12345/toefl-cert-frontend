...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    {
      label: "Issued",
      value: certs.filter((c) => c.status === "issued").length,
      icon: FileCheck,
    ...
    {
      label: "Revoked",
      value: certs.filter((c) => c.status === "revoked").length,
      icon: XCircle,
      color: "text-red-500",
      bg: "bg-red-50",
    },
    {
      label: "Pending",
      value: certs.filter((c) => c.status === "pending").length,
      icon: Clock,
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">
          Kelola dan monitor sertifikat TOEFL
        </p>
      </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {certs.map((cert) => (
                  ...
                  >
                    <td className="py-3 px-4 font-mono text-xs text-primary-700 font-semibold">
                      {cert.certId}
                    </td>
