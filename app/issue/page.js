...
export default function IssuePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || "Gagal menerbitkan sertifikat",
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="card border-l-4 border-emerald-500">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Tersimpan di Blockchain Ethereum Sepolia
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  <span className="text-sm font-semibold text-gray-600 w-32 shrink-0">
                    {label}
                  </span>
                  <div className="flex items-center gap-2 flex-1 min-w-0">
                    <span
                      className={`text-sm text-gray-800 truncate ${mono ? "font-mono text-xs" : ""}`}
                    >
                      {value}
                    </span>
                    {mono && (
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-xl flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mb-2">
                    Scan untuk verifikasi sertifikat
                  </p>
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 mb-8">
        Terbitkan sertifikat TOEFL ke Blockchain Ethereum Sepolia
      </p>
        ...
        <form onSubmit={handleSubmit} className="card space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                className="input"
                placeholder="UIN Alauddin Makassar"
          ...
          <div>
            ...
            {file && (
              <p className="text-xs text-emerald-600 mt-1">
                ✓ QR Code akan di-embed ke dalam PDF ini
              </p>
            )}
          </div>
